...
<!-- Navbar (Top Bar) -->
<nav class="bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 ps-60">
    <div class="max-w-screen-xl px-4 py-2 mx-auto flex items-center justify-between">
        ...
        <div class="flex items-center">
            <span class="text-xl font-semibold text-gray-800 dark:text-white">Staff Book Controller</span>
        </div>
...
<aside id="separator-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{route('staff.loanRequest')}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-xs font-semibold text-gray-100 bg-red-600 rounded-full">5</span>
                </a>
            </li>
